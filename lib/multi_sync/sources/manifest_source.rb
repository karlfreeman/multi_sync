...
module MultiSync
  ...
  class ManifestSource < Source
    ...
    def parse_manifest(manifest_path)
      ...
      if manifest_hash.has_key?("files") || manifest_hash.has_key?("assets")
